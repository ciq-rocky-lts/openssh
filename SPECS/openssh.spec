...
Name:                 openssh
Version:              %{openssh_ver}
Release:              %{openssh_rel}%{?dist}.1.0.2
...
Patch1021:            openssh-8.7p1-rocky-CVE-2024-6409.patch
...
Release:              %{pam_ssh_agent_rel}.%{openssh_rel}%{?dist}.1.0.2
License:              BSD
...
%changelog
* Mon Jul 08 2024 Solar Designer <solar@openwall.com> - 8.7p1-38.0.2.0.2
- Fix CVE-2024-6409
