...
Name: openssh
Version: %{openssh_ver}
Release: %{openssh_rel}%{?dist}.rocky.0.1
...
Release: %{pam_ssh_agent_rel}.%{openssh_rel}%{?dist}.rocky.0.1
License: BSD
...
%changelog
* Fri Jun 26 2026 Jeremy Allison <jallison@samba.org> - 8.7p1-49.rocky.0.1
- Roll 9.6LTS forward to openssh from 9.7 for CVE fixes.

* Tue May 05 2026 Release Engineering <releng@rockylinux.org> - 8.7p1-49.rocky.0.1
