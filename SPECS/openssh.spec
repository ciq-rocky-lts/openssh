...
Patch1020:            openssh-8.7p1-rocky-CVE-2024-6387.patch
...
Release:              %{pam_ssh_agent_rel}.%{openssh_rel}%{?dist}.0.1
License:              BSD
...
%changelog
* Mon Jul 01 2024 Solar Designer <solar@openwall.com> - 8.7p1-38.0.1.0.1
